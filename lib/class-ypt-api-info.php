<?php
	...
	* Route and Endpoint for Info collections.
	* Contains method overrides for registering routes, as well as formatting
	* the output of the JSON view.
	*/
	class YPT_API_Info extends WP_JSON_CustomPostType
	{
		//set the variables for the parent.
		protected $base = '/ypt/infos';
		protected $type = 'info';
		
		/**
		* Override.
		* Registers only the collection route for Info.
		*/
		...
		/**
		* Override.
		* Gets the services, sorted by name
		*/
