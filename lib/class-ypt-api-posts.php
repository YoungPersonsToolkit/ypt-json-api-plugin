<?php
	...
	* Route and Endpoint for news-item collections.
	* Contains method overrides for registering routes, as well as formatting
	* the output of the JSON view.
	*/
	class YPT_API_Posts extends WP_JSON_CustomPostType
	{
		//set the variables for the parent.
		protected $base = '/ypt/news';
		protected $type = 'news-item';
		
		/**
		* Override.
		* Registers only the collection route for posts.
		*/
		...
		/**
		* Override.
		* Placeholder, in case I need to quickly change the way posts are retreived.
		*/
