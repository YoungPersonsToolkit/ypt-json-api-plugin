<?php
	...
	* Route and Endpoint for Service collections.
	* Contains method overrides for registering routes, as well as formatting
	* the output of the JSON view.
	*/
	class YPT_API_Services extends WP_JSON_CustomPostType
	{
		//set the variables for the parent.
		protected $base = '/ypt/services';
		protected $type = 'service';
		
		/**
		* Override.
		* Registers only the collection route for Services.
		*/
