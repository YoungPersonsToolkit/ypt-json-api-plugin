<?php
	...
	* Route and Endpoint for single Info posts (/ypt/info/<n>)
	* Contains method overrides for registering routes, as well as formatting
	* the output of the JSON view.
	*/
	class YPT_API_Info_Single extends WP_JSON_CustomPostType
	{
		//set the variables for the parent.
		protected $base = '/ypt/info';
		protected $type = 'info';
		
		/**
		* Override.
		* Registers only the singlular route for information.
		*/
